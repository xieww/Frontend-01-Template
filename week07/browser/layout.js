function getStyle(element) {
  ...
  for (const prop in element.computedStyle) {
    ...
    let elementStyle = element.style[prop];
    elementStyle = element.computedStyle[prop].value;
    if (elementStyle.toString().match(/px$/) || elementStyle.toString().match(/^[0-9\.]+$/)) {
      elementStyle = parseInt(elementStyle);
    }
  }
